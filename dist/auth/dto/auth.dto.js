...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'CRP-01/12345' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^CRP-\d{2}\/\d{4,6}$/, {
        message: 'CRP deve ter o formato CRP-XX/XXXXX'
    }),
    __metadata("design:type", String)
], RegisterDto.prototype, "crp", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Psicologia Clínica', required: false }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
